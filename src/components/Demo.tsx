...
import { FarcasterOAuthAction } from "~/components/actions/farcaster-oauth";
...
export default function Demo() {
  ...
  const actionDefinitions: ActionDefinition[] = [
    ...
    {
      id: "farcaster-oauth",
      name: "Farcaster OAuth (Thirdweb)",
      description: "Connect with Farcaster using Thirdweb inAppWallet",
      component: FarcasterOAuthAction,
    },
    {
      id: "quickauth",
      name: "Quick Auth",
